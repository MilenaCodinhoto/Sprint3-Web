                        ...
                        <div class="box-corrida">
                            ...
                            <div class="box-info">
                                <div class="info-corrida">
                                    ...
                                    <img src="../imgs-circuito/portland-bandeira.png"
                                        alt="bandeira do pais de origem do circuito da próxima corrida">
                                </div>
                                <img src="../imgs-circuito/portland-corrida.png" class="img-corrida"
                                    alt="Circuito da próxima corrida">
                            </div>
                            <h4>Portland</h4>
                        </div>
                    </div>
                    <div class="tempo-corrida">
                        <p id="round">ROUND 13</p>
                        <p id="time">01:00:06</p>
                    </div>
                </div>
            </div>
            <div id="card" class="card">
                <div class="box">
                    <div class="bg-titulo">
                        <div class="titulo-card">
                            <img src="../imgs-circuito/berlin-bandeira.png"
                                alt="Bandeira do pais de origem do circuito">
                            <h3>Berlim</h3>
                        </div>
                    </div>
                    <img src="../imgs-circuito/berlin-corrida.png" class="img-card" alt="Imagem do circuito de berlim">
                </div>
            </div>
            <div id="card" class="card">
                <div class="box">
                    <div class="bg-titulo">
                        <div class="titulo-card">
                            <img src="../imgs-circuito/londres-bandeira.png"
                                alt="Bandeira do pais de origem do circuito">
                            <h3>Londres</h3>
                        </div>
                    </div>
                    <img src="../imgs-circuito/londres-corrida.png" class="img-card" alt="Imagem do circuito de londres">
                </div>
            </div>
            <div id="card" class="card">
                <div class="box">
                    <div class="bg-titulo">
                        <div class="titulo-card">
                            <img src="../imgs-circuito/monaco-bandeira.png"
                                alt="Bandeira do pais de origem do circuito">
                            <h3>Monaco</h3>
                        </div>
                    </div>
                    <img src="../imgs-circuito/monaco-corrida.png" class="img-card" alt="Imagem do circuito de monaco">
                </div>
            </div>
            <div id="card" class="card">
                <div class="box">
                    ...
                    <img src="../imgs-circuito/portland-corrida.png" class="img-card" alt="Imagem do circuito de portland">
                </div>
            </div>
            <div id="card" class="card">
                <div class="box">
                    <div class="bg-titulo">
                        <div class="titulo-card">
                            <img src="../imgs-circuito/shangai-bandeira.png"
                                alt="Bandeira do pais de origem do circuito">
                            <h3>Shangai</h3>
                        </div>
                    </div>
                    <img src="../imgs-circuito/shangai-corrida.png" class="img-card" alt="Imagem do circuito de shangai">
                </div>
            </div>
        </section>
